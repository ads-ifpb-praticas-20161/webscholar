...
ADD target/webscholar.war $WORKDIR
ADD target/webscholar/WEB-INF/lib/ /usr/glassfish4/glassfish/lib/

CMD asadmin start-domain && asadmin deploy webscholar.war  && tail -f /dev/null
